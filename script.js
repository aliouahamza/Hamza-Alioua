...
function changeLanguage(lang) {
    ...
    // إعادة تعيين تفاصيل الماجستير إذا لزم الأمر
...
function toggleTheme() {
    ...
    // إعادة تهيئة الجسيمات بالألوان الجديدة
...
function initializeEventListeners() {
    ...
    // تأثيرات التمرير على البطاقات الاجتماعية
...
function handleSkillSearch(e) {
    ...
    if (visibleCount === 0 && searchTerm) {
        if (!noResults) {
            ...
            message.style.cssText = 'text-align: center; padding: 2rem; color: var(--text-muted); grid-column: 1 / -1;';
